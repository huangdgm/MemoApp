...
using Java.IO;
using Xamarin.Forms;
using App3.Droid.Services;
using App3.Services;

[assembly: Dependency(typeof(AudioRecorderService))]
namespace App3.Droid.Services
{
    public class AudioRecorderService : IAudioRecorderService
    {
        ...
        Android.Media.Encoding RECORDER_AUDIO_ENCODING = Android.Media.Encoding.Pcm16bit;
        ...
        public void StartRecording()
        {
            ...
            bufferSize = AudioRecord.GetMinBufferSize(RECORDER_SAMPLERATE, ChannelIn.Mono, Android.Media.Encoding.Pcm16bit);
        ...
        {
            var path = System.Environment.GetFolderPath(System.Environment.SpecialFolder.Personal);
            return Path.Combine(path, "Memo.wav");
        }
